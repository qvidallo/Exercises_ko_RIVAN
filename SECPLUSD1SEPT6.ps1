...
!!!DAPAT 7 UNDER_SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
client-identifier fc5b.3978.3f30
...
conf t
 ...
 ip route 10.42.0.0 255.255.0.0 10.42.42.4
 NO ip route 10.42.0.0 255.255.0.0 200.0.0.42
 end
...
conf t 
ip routing
ip route 0.0.0.0 0.0.0.0 10.42.42.1
end
...
conf t
ip routing
ip route 0.0.0.0 0.0.0.0 10.42.100.4
end
